...
public class PlayerController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        _isGrounded = Physics2D.OverlapCircle(leftPoint, groundCheckRadius, groundLayer)
                   || Physics2D.OverlapCircle(centerPoint, groundCheckRadius, groundLayer)
                   || Physics2D.OverlapCircle(rightPoint, groundCheckRadius, groundLayer);
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(groundCheck.position + Vector3.left * 0.2f, groundCheckRadius);
        Gizmos.DrawWireSphere(groundCheck.position, groundCheckRadius);
        Gizmos.DrawWireSphere(groundCheck.position + Vector3.right * 0.2f, groundCheckRadius);
